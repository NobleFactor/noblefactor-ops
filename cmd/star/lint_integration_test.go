...
// setupLintApplication creates a runtime with extensions loaded and changes to the test dir.
func setupLintApplication(t *testing.T, testDir string) (*Application, error) {
	t.Helper()
...
`},
	...
	r, err := setupLintApplication(t, dir)
	if err != nil {
