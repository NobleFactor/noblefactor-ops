...
func (r *YAMLReceiver) AttrNames() []string {
	return []string{"decode", "encode"}
}

// encode encodes a Starlark value as YAML.
func (r *YAMLReceiver) encode(_ *starlark.Thread, _ *starlark.Builtin, args starlark.Tuple, kwargs []starlark.Tuple) (starlark.Value, error) {
...
// decode decodes YAML into a Starlark value.
func (r *YAMLReceiver) decode(_ *starlark.Thread, _ *starlark.Builtin, args starlark.Tuple, kwargs []starlark.Tuple) (starlark.Value, error) {
	var s string
