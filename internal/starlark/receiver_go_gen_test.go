...
// testGraphOpsTemplate is the graph_ops template content, kept as a
// test-local constant after the template was removed from production code.
// Production callers (devlore-cli) load it from a .go.tmpl file instead.
const testGraphOpsTemplate = `// Code generated by go.generate; DO NOT EDIT.
...
func TestGenerateGraphOps(t *testing.T) {
	...
	result := callMethod(t, r, "generate",
		starlark.Tuple{starlark.String(testGraphOpsTemplate), desc}, nil)
