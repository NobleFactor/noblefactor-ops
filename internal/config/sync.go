...
// syncGolangciLint writes .golangci.yaml from star/config.yaml config.
func (c *builtinConfig) syncGolangciLint() (string, error) {
	// Use git workspace root for file paths
...
// syncMarkdownLint writes .markdownlint-cli2.yaml from star/config.yaml config.
...
// syncPrecommitConfig writes .pre-commit-config.yaml from star/config.yaml config.
...
// Returns the generated path if star/config.yaml has config, otherwise empty.
